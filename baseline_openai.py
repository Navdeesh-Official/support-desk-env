"""OpenAI baseline agent for SupportDeskEnv.

Usage:
    python baseline_openai.py [--base-url URL] [--model MODEL] [--task TASK_ID]

Requires OPENAI_API_KEY environment variable.
Optional OPENAI_MODEL environment variable (default: gpt-4.1-mini).
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="OpenAI baseline for SupportDeskEnv")
